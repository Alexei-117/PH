        ...
        if(isset($_SESSION["nombre"])){
            ...
            if($contador==0){
                ...
                <form action="confirmar.php" method="POST" oninput="range_control_value.value = range_control.valueAsNumber" class="album-form">
                    ...
                    <br>
                    <label class="labelForm" for="titleInput">Título de álbum:</label><input id="titleInput" class="formInput" type="text" name="title_control" required />
                    <br>
                    ...
                    <br>
                    <label class="labelForm" for=dateInput">Fecha:</label><input id="dateInput" class="formInput type="date" name="date_control"/>
                    <br>
                    ...
                    <label class="labelForm" for="colorInput2">A color:</label>
                        <input id="colorInput2" class="labelFormRadio" type="radio" name="color_control1" value="1" checked/>
                        <label class="radioLabel" id="modoLabel1" for="colorInput2">blanco y negro</label>
                        <br>
                        <input class="labelFormRadio" id="modoLabel2" type="radio" name="color_control2" value="2"/>
